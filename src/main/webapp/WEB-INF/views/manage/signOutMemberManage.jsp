...
<body>
	...
	<form id="f" action="${contextPath}/admin/memberCheckRemove" method="post">
			...
			<tbody>
				<c:forEach items="${members}" var="member" varStatus="vs">
					<tr>
						...
						<td><a href="${contextPath}/admin/memberDetail?memberNo=${member.memberNo}&value=${value}">${member.memberName}</a></td>
						<td>${member.memberPhone}</td>
						<td>${member.memberEmail}</td>
						<td>${member.memberRoadAddress}</td>
						<td>${member.memberSignUp}</td>					
						<td><a href="${contextPath}/admin/memberRemove?memberNo=${member.memberNo}&value=${value}" onclick="return confirm('정말 삭제하시겠습니까?')"><i class="fa-solid fa-circle-xmark"></i></a></td>					
